...
//        Path directory = FileSystems.getDefault().getPath("FileTree/Dir2");  // FileTree\\Dir2 (windows)
        ...
        Path dir2Path = FileSystems.getDefault().getPath("files" );
        try {
        ...
        Path copyPath = FileSystems.getDefault().getPath("copied");
        //    FileTree/Dir4/Dir2Copy
        try {
            Files.walkFileTree(dir2Path, new TreeCopy(dir2Path, copyPath));
