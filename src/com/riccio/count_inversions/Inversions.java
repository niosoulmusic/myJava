 ...
 * @author Euge Riccio
 */
package com.riccio.count_inversions;
import java.io.*;
...
public class Inversions {
    ...
    public static void main(String [] args) {
        ...
        File file = new File(System.getProperty("user.dir")+"/txt/IntegerArray.txt");
        int temp, k = 0;
        int count = 0;

        /* Count the number of lines in the text file to find the correct array's size */
        try {
            count = countLines(System.getProperty("user.dir")+"/txt/IntegerArray.txt");
        }
        catch (IOException e) {
